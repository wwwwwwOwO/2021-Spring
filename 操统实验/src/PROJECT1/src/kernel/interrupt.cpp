...
void InterruptManager::initialize()
{
    ...
    setInterruptDescriptor(0, (uint32)asm_DE, 0);
    setInterruptDescriptor(14, (uint32)asm_PF, 3);
...
// 中断处理函数
extern "C" void c_DE_handler()
{
    printf("Devide Error!\n");
}

// 中断处理函数
extern "C" void c_PF_handler(uint32 index)
{
    return swapManager.doPageFault();
}
